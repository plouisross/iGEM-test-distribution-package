...
print(f'Converting SBOL2 to SBOL3 files for package {os.path.basename(package)}')
try:
    # convert files
    mappings = scriptutils.convert_package_sbol2_files(package)
    ...
    print(f'Could not convert SBOL2 files for package {os.path.basename(package)}: {e}')
    error = True
